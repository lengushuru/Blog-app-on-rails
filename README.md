...
>**Blog app: is a fully functional rails application showcasing a list of posts and enabling reader interaction through comments and post liking will be developed as a classic example of a blog website users can also perform CRUD operations**.<a name="built-with"></a>
...
```sh
  git clone https://github.com/lengushuru/Blog-app-on-rails.git
```
...
I would like to thank microverse for giving me this opprtunity.
